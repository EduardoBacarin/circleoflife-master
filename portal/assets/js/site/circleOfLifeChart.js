angular.module("app", ["chart.js"]).controller("BaseCtrl",
    function ($scope, $http, $element) {
        ...
        $scope.getCircleData = function () {
            ...
            $http.get("/circleoflife-master/portal/main/getCircleOfLifeByUserId/" + $scope.userId).then(function (response) {
        ...
        $scope.onClick = function (points, evt) {
            ...
            angular.element(assessment).css('display', 'block');
        ...
        $scope.saveCircleChanges = function () {
            ...
            $http({
                url: '/circleoflife-master/portal/main/writeCircleOfLifeFromUser/',
