  ...
  <div class="mainbar">
      ...
      <div class="page-head">
        ...
        <div class="bread-crumb pull-right">
          ...
          <a href="#" class="bread-current">View Administrators</a>
        </div>
          ...
          <div class="row">
              <div class="col-md-12">
                ...
                <div class="widget-head">
                  <div class="pull-left">Administrators</div>
  ...
  <tbody>
    <?php
      ...
      foreach($admins['admins'] as $admin){
        echo "<tr>";
        echo "<td class='clickable-td' data-href='".$portal_path."main/viewadmin/".$admin['id']."'>".($i++)."</td>";  
        echo "<td class='clickable-td' data-href='".$portal_path."main/viewadmin/".$admin['id']."'>".$admin['f_name']." ".$admin['l_name']."</td>";
        echo "<td class='clickable-td' data-href='".$portal_path."main/viewadmin/".$admin['id']."'>".$admin['date_created']."</td>";
        echo "<td align='right' class='clickable-td' data-href='".$portal_path."main/viewadmin/".$admin['id']."'> 0 </td>";
        echo "<td align='right' class='clickable-td' data-href='".$portal_path."main/viewadmin/".$admin['id']."'> 0.00 </td>";
        echo "</tr>";
      }
    ?>
  </tbody>
