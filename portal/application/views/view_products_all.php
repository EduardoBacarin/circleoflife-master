...
?>
  <div class="mainbar">
      <!-- Page heading -->
      <div class="page-head">
        <h2 class="pull-left"><i class="fa fa-file-o"></i>View Products</h2>
        <!-- Breadcrumb -->
        <div class="bread-crumb pull-right">
          <a href="<?php echo $portal_path; ?>main/"><i class="fa fa-home"></i> Home</a> 
          <!-- Divider -->
          <span class="divider">/</span> 
          <a href="#" class="bread-current">View Products</a>
        </div>
  ...
  <tbody>
    <?php
      ...
      foreach($products['products'] as $product){
        echo "<tr>";
        /*echo "<td class='clickable-td' data-href='".$portal_path."main/viewProduct/".$product['id']."'>".$product['id']."</td>";
        echo "<td class='clickable-td' data-href='".$portal_path."main/viewProduct/".$product['id']."'>".$product['code']."</td>";
        echo "<td class='clickable-td' data-href='".$portal_path."main/viewProduct/".$product['id']."'>".$product['type']."</td>";
        echo "<td class='clickable-td' data-href='".$portal_path."main/viewProduct/".$product['id']."'>".number_format($product['price'])."</td>";
        echo "<td class='clickable-td' data-href='".$portal_path."main/viewProduct/".$product['id']."'>".number_format($product['commission'], 2, '.', '')."</td>";
         echo "<td class='clickable-td' data-href='".$portal_path."main/viewProduct/".$product['id']."'>".$product['description']."</td></tr>";
         */
         //TO MAKE ROW CLICABLE UNCOMENT CODE ABOVE AND REMOVE CODE BELOW
         echo "<td>".$product['id']."</td>";
        echo "<td>".$product['code']."</td>";
        echo "<td>".$product['type']."</td>";
        echo "<td>".number_format($product['price'], 2, '.', '')."</td>";
        echo "<td>".number_format($product['commission'], 2, '.', '')."</td>";
