...
?>
  <div class="mainbar">
      <!-- Page heading -->
      <div class="page-head">
        <h2 class="pull-left"><i class="fa fa-file-o"></i>View Coachs</h2>
        <!-- Breadcrumb -->
        <div class="bread-crumb pull-right">
          <a href="<?php echo $portal_path; ?>main/"><i class="fa fa-home"></i> Home</a> 
          <!-- Divider -->
          <span class="divider">/</span> 
          <a href="#" class="bread-current">View Coachs</a>
        </div>
...
<table> <!-- bootstrap classes added by the uitheme widget -->
 <thead>
  ...
  <tbody>
    <?php
      $i = 1;  
      foreach($sales_reps['sales_reps'] as $sales_rep){
        echo "<tr>";
        echo "<td class='clickable-td' data-href='".$portal_path."main/viewsalesrep/".$sales_rep['id']."'>".($i++)."</td>";  
        echo "<td class='clickable-td' data-href='".$portal_path."main/viewsalesrep/".$sales_rep['id']."'>".$sales_rep['f_name']." ".$sales_rep['l_name']."</td>";
        echo "<td class='clickable-td' data-href='".$portal_path."main/viewsalesrep/".$sales_rep['id']."'>".$sales_rep['date_created']."</td>";
        echo "<td align='right' class='clickable-td' data-href='".$portal_path."main/viewsalesrep/".$sales_rep['id']."'> 0 </td>";
        echo "<td align='right' class='clickable-td' data-href='".$portal_path."main/viewsalesrep/".$sales_rep['id']."'> 0.00 </td>";
        echo "</tr>";
      }
    ?>
  </tbody>
...
<footer>
  <div class="container">
    <div class="row">
      <div class="col-md-12">
            <!-- Copyright info -->
            <p class="copy">Copyright &copy; 2017 | <a href="#">Stars GPS</a> </p>
      </div>
    </div>
  </div>
</footer>   
