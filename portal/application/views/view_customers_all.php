...
?>
  <div class="mainbar">
      <!-- Page heading -->
      <div class="page-head">
        <h2 class="pull-left"><i class="fa fa-file-o"></i>View Clients</h2>
        <!-- Breadcrumb -->
          ...
          <div class="row">
              <div class="col-md-12">
                ...
                <div class="widget-head">
                  <div class="pull-left">Clinets</div>
...
<table> <!-- bootstrap classes added by the uitheme widget -->
 <thead>
    <tr>
      <th>#</th>
      <th data-sorter="false" data-filter="false"> <i class="fa fa-eye" aria-hidden="true"> </th>
      <th>Client</th>
      <th>Name</th>
      <th>Address</th>
      <th>Phone</th>
  ...
  <tbody>
    <?php
      ...
      foreach($customers['customers'] as $customer){
        echo "<tr>";
        echo "<td class='clickable-td' data-href='".$portal_path."main/viewcustomer/".$customer['account_id']."'>".($i++)."</td>";
        echo "<td><input type='checkbox' name='view' id='view' value='".($mapIndex++).",".preg_replace('/[^A-Za-z0-9\- ]/', '', $customer['name']).",".$customer['point']."'></td>";  
        echo "<td class='clickable-td' data-href='".$portal_path."main/viewcustomer/".$customer['account_id']."'>".$customer['name']."</td>";
        echo "<td class='clickable-td' data-href='".$portal_path."main/viewcustomer/".$customer['account_id']."'>".$customer['customerName']."</td>";
        echo "<td class='clickable-td' data-href='".$portal_path."main/viewcustomer/".$customer['account_id']."'>".$customer['address'].", ".$customer['city'].", ".$customer['state']." ".$customer['zip']."</td>";
        echo "<td class='clickable-td' data-href='".$portal_path."main/viewcustomer/".$customer['account_id']."'>".$customer['phone']."</td>";
        echo "<td class='clickable-td' data-href='".$portal_path."main/viewcustomer/".$customer['account_id']."'>".$customer['email']."</td>";
        echo "<td class='clickable-td' data-href='".$portal_path."main/viewcustomer/".$customer['account_id']."'>".$customer['salesRepName']."</td></tr>";
      }
    ?>
  </tbody>
</table>
