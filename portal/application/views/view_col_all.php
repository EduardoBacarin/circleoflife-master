  ...
  <div class="mainbar">
      ...
      <div class="page-head">
        ...
        <div class="bread-crumb pull-right">
          ...
          <a href="#" class="bread-current">View CoL Areas</a>
        </div>
          ...
          <div class="row">
              <div class="col-md-12">
                ...
                <div class="widget-head">
                  <div class="pull-left">Col Name</div>
 ...
 <thead>
  ...
  <tbody>
    <?php
      $i = 1;
      $mapIndex = 0;
      foreach($col_areas->result_array() as $col_areas){
        echo "<tr>";
        echo "<td class='clickable-td' data-href='".$portal_path."main/viewcol/".$col_areas['id']."'>".$col_areas['id']."</td>";
        echo "<td class='clickable-td' data-href='".$portal_path."main/viewcol/".$col_areas['id']."'>".$col_areas['description']."</td>";
      }
    ?>
  </tbody>
</table>
