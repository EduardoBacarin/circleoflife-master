...
?>
    ...
    <div class="mainbar">
      ...
      <div class="page-head">
        <!-- Page heading -->
        <h2 class="pull-left"><i class="fa fa-file-o"></i><?php echo " ".$sales_rep_info->f_name." ".$sales_rep_info->l_name; ?> - Coach</h2>
        </h2>
        ...
        <div class="bread-crumb pull-right">
          ...
          <a href="#" class="bread-current">Coach</a>
        </div>
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <form class="form-horizontal" role="form" id="editUserType" name="editUserType" action="<?php echo $portal_path;?>account/edit_usertype" method="POST">                                                <div class="form-group">
                          ...
                          <div class="col-lg-8">
                            <input type="text" class="form-control" placeholder="First Name" id="f_name" name="f_name" value="<?php echo $sales_rep_info->f_name; ?>" readonly>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-8">
                            <input type="text" class="form-control" placeholder="Last Name" id="l_name" name="l_name" value="<?php echo $sales_rep_info->l_name; ?>" readonly>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-8">
                            <input type="text" class="form-control" placeholder="Email" id="email" name="email" value="<?php echo $sales_rep_info->email ?>" readonly>
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="col-lg-offset-2 col-lg-12">
                            ...
                            <!-- Form Calls -->
                              <input form="editUserType" type="hidden" name="user_type" value="Admin">
                              <input form="editUserType" type="hidden" name="user_id" value="<?php echo $sales_rep_info->id; ?>">
                              <button form="editUserType" id="editUserType" type="submit" name="editUserType" value="editUserType" class="btn btn-sm btn-primary">Promote to Admin</button>
