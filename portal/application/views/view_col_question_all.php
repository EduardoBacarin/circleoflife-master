...
?>
  <div class="mainbar">
      <!-- Page heading -->
      <div class="page-head">
        <h2 class="pull-left"><i class="fa fa-file-o"></i>View CoL Areas</h2>
        <!-- Breadcrumb -->
        <div class="bread-crumb pull-right">
          <a href="<?php echo $portal_path; ?>main/"><i class="fa fa-home"></i> Home</a>
          <!-- Divider -->
          <span class="divider">/</span>
          <a href="#" class="bread-current">View CoL Question</a>
        </div>
          ...
          <div class="row">
              <div class="col-md-12">
                ...
                <div class="widget-head">
                  <div class="pull-left">Col Question for all Areas </div>
 ...
 <thead>
  ...
  <tbody>
    <?php
      $i = 1;
      $mapIndex = 0;
      foreach($col_questions['col'] as $col_questions){
        echo "<tr>";
        echo "<td class='clickable-td' data-href='".$portal_path."main/viewcolquestion/".$col_questions['id']."'>".$col_questions['id']."</td>";
        echo "<td class='clickable-td' data-href='".$portal_path."main/viewcolquestion/".$col_questions['id']."'>".$col_questions['col_name']."</td>";
        echo "<td class='clickable-td' data-href='".$portal_path."main/viewcolquestion/".$col_questions['id']."'>".$col_questions['question_number']."</td>";
        echo "<td class='clickable-td' data-href='".$portal_path."main/viewcolquestion/".$col_questions['id']."'>".$col_questions['description']."</td>";
      }
    ?>
  </tbody>
</table>
